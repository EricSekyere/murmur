...
- **Developer mode:** dictate code with tech-term correction, spoken symbols (`fat arrow` → `=>`), filler removal, casing commands (camel, snake, pascal, kebab), spoken file paths, and Conventional Commit messages by voice.
